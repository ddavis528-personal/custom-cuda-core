...
//
// COMMON PORTS. clk is the block's gated clock, made here from
// core_clk; the gate enable is tied high because the power
// controller that would drive it from sleep_ok/wake_req is not
// specified. rst_n fans out directly; the reset tree (block letter
// z) is not modelled yet. kill_valid/kill_warp_mask are broadcast
// from the top: the schema says kill comes from RAU, but RAU has no
// kill OUTPUT. The per-block kill_ack, wake_req, sleep_ok and CSR
// ports have no fabric in the spec, so they are brought to this
// boundary as vectors indexed by block instance rather than wired
// to a guess.
//
...
module ccv_core_top (
  ...
  input  logic [44:0] wake_req,
  input  logic [2204:0] csr_req,
  output logic [44:0] kill_ack,
  output logic [44:0] sleep_ok,
  output logic [1484:0] csr_rsp,
  output logic [44:0] csr_credit,
...
`endif
  ...
  logic [959:0] fet_dec_instr_payload;
...
`endif
  ...
  logic [223:0] ooe_rcu_issue_payload;
...
`endif
  ...
  // Per-block gated clocks. Gate enable tied high: see above.
  wire fet_clk_en = 1'b1;
  wire fet_core_clk = core_clk & fet_clk_en;
  wire dec_clk_en = 1'b1;
  wire dec_core_clk = core_clk & dec_clk_en;
  wire ooe_clk_en = 1'b1;
  wire ooe_core_clk = core_clk & ooe_clk_en;
  wire rcu_clk_en = 1'b1;
  wire rcu_core_clk = core_clk & rcu_clk_en;
  wire lane_00_clk_en = 1'b1;
  wire lane_00_core_clk = core_clk & lane_00_clk_en;
  wire lane_01_clk_en = 1'b1;
  wire lane_01_core_clk = core_clk & lane_01_clk_en;
  wire lane_02_clk_en = 1'b1;
  wire lane_02_core_clk = core_clk & lane_02_clk_en;
  wire lane_03_clk_en = 1'b1;
  wire lane_03_core_clk = core_clk & lane_03_clk_en;
  wire lane_04_clk_en = 1'b1;
  wire lane_04_core_clk = core_clk & lane_04_clk_en;
  wire lane_05_clk_en = 1'b1;
  wire lane_05_core_clk = core_clk & lane_05_clk_en;
  wire lane_06_clk_en = 1'b1;
  wire lane_06_core_clk = core_clk & lane_06_clk_en;
  wire lane_07_clk_en = 1'b1;
  wire lane_07_core_clk = core_clk & lane_07_clk_en;
  wire lane_08_clk_en = 1'b1;
  wire lane_08_core_clk = core_clk & lane_08_clk_en;
  wire lane_09_clk_en = 1'b1;
  wire lane_09_core_clk = core_clk & lane_09_clk_en;
  wire lane_10_clk_en = 1'b1;
  wire lane_10_core_clk = core_clk & lane_10_clk_en;
  wire lane_11_clk_en = 1'b1;
  wire lane_11_core_clk = core_clk & lane_11_clk_en;
  wire lane_12_clk_en = 1'b1;
  wire lane_12_core_clk = core_clk & lane_12_clk_en;
  wire lane_13_clk_en = 1'b1;
  wire lane_13_core_clk = core_clk & lane_13_clk_en;
  wire lane_14_clk_en = 1'b1;
  wire lane_14_core_clk = core_clk & lane_14_clk_en;
  wire lane_15_clk_en = 1'b1;
  wire lane_15_core_clk = core_clk & lane_15_clk_en;
  wire lane_16_clk_en = 1'b1;
  wire lane_16_core_clk = core_clk & lane_16_clk_en;
  wire lane_17_clk_en = 1'b1;
  wire lane_17_core_clk = core_clk & lane_17_clk_en;
  wire lane_18_clk_en = 1'b1;
  wire lane_18_core_clk = core_clk & lane_18_clk_en;
  wire lane_19_clk_en = 1'b1;
  wire lane_19_core_clk = core_clk & lane_19_clk_en;
  wire lane_20_clk_en = 1'b1;
  wire lane_20_core_clk = core_clk & lane_20_clk_en;
  wire lane_21_clk_en = 1'b1;
  wire lane_21_core_clk = core_clk & lane_21_clk_en;
  wire lane_22_clk_en = 1'b1;
  wire lane_22_core_clk = core_clk & lane_22_clk_en;
  wire lane_23_clk_en = 1'b1;
  wire lane_23_core_clk = core_clk & lane_23_clk_en;
  wire lane_24_clk_en = 1'b1;
  wire lane_24_core_clk = core_clk & lane_24_clk_en;
  wire lane_25_clk_en = 1'b1;
  wire lane_25_core_clk = core_clk & lane_25_clk_en;
  wire lane_26_clk_en = 1'b1;
  wire lane_26_core_clk = core_clk & lane_26_clk_en;
  wire lane_27_clk_en = 1'b1;
  wire lane_27_core_clk = core_clk & lane_27_clk_en;
  wire lane_28_clk_en = 1'b1;
  wire lane_28_core_clk = core_clk & lane_28_clk_en;
  wire lane_29_clk_en = 1'b1;
  wire lane_29_core_clk = core_clk & lane_29_clk_en;
  wire lane_30_clk_en = 1'b1;
  wire lane_30_core_clk = core_clk & lane_30_clk_en;
  wire lane_31_clk_en = 1'b1;
  wire lane_31_core_clk = core_clk & lane_31_clk_en;
  wire miu_clk_en = 1'b1;
  wire miu_core_clk = core_clk & miu_clk_en;
  wire spm_clk_en = 1'b1;
  wire spm_core_clk = core_clk & spm_clk_en;
  wire dcu_clk_en = 1'b1;
  wire dcu_core_clk = core_clk & dcu_clk_en;
  wire mlc_clk_en = 1'b1;
  wire mlc_core_clk = core_clk & mlc_clk_en;
  wire rau_clk_en = 1'b1;
  wire rau_core_clk = core_clk & rau_clk_en;
  wire syu_clk_en = 1'b1;
  wire syu_core_clk = core_clk & syu_clk_en;
  wire pca_clk_en = 1'b1;
  wire pca_core_clk = core_clk & pca_clk_en;
  wire cru_clk_en = 1'b1;
  wire cru_core_clk = core_clk & cru_clk_en;
  wire exb_clk_en = 1'b1;
  wire exb_core_clk = core_clk & exb_clk_en;
  ...
  ccv_fet u_fet (
    ...
    .wake_req(wake_req[0]),
    .sleep_ok(sleep_ok[0]),
    .csr_req(csr_req[0 +: 49]),
    .csr_rsp(csr_rsp[0 +: 33]),
    .csr_credit(csr_credit[0]),
...
`endif
  ...
  ccv_dec u_dec (
    ...
    .wake_req(wake_req[1]),
    .sleep_ok(sleep_ok[1]),
    .csr_req(csr_req[49 +: 49]),
    .csr_rsp(csr_rsp[33 +: 33]),
    .csr_credit(csr_credit[1]),
    .fet_dec_instr_valid(fet_dec_instr_valid),
    .fet_dec_instr_payload(fet_dec_instr_payload),
    .fet_dec_instr_credit(fet_dec_instr_credit),
    .fet_dec_instr_stall(fet_dec_instr_stall),
...
`endif
  ...
  ccv_ooe u_ooe (
    ...
    .wake_req(wake_req[2]),
    .sleep_ok(sleep_ok[2]),
    .csr_req(csr_req[98 +: 49]),
    .csr_rsp(csr_rsp[66 +: 33]),
    .csr_credit(csr_credit[2]),
    .dec_ooe_uop_valid(dec_ooe_uop_valid),
    .dec_ooe_uop_payload(dec_ooe_uop_payload),
    .dec_ooe_uop_credit(dec_ooe_uop_credit),
    .dec_ooe_uop_stall(dec_ooe_uop_stall),
...
`endif
  ...
  ccv_rcu u_rcu (
    ...
    .wake_req(wake_req[3]),
    .sleep_ok(sleep_ok[3]),
    .csr_req(csr_req[147 +: 49]),
    .csr_rsp(csr_rsp[99 +: 33]),
    .csr_credit(csr_credit[3]),
    .ooe_rcu_issue_valid(ooe_rcu_issue_valid),
    .ooe_rcu_issue_payload(ooe_rcu_issue_payload),
    .ooe_rcu_issue_credit(ooe_rcu_issue_credit),
    .ooe_rcu_issue_stall(ooe_rcu_issue_stall),
...
`endif
  ...
  ccv_lane u_lane_00 (
    ...
    .wake_req(wake_req[4]),
    .sleep_ok(sleep_ok[4]),
    .csr_req(csr_req[196 +: 49]),
    .csr_rsp(csr_rsp[132 +: 33]),
    .csr_credit(csr_credit[4]),
...
`endif
  ...
  ccv_lane u_lane_01 (
    ...
    .wake_req(wake_req[5]),
    .sleep_ok(sleep_ok[5]),
    .csr_req(csr_req[245 +: 49]),
    .csr_rsp(csr_rsp[165 +: 33]),
    .csr_credit(csr_credit[5]),
...
`endif
  ...
  ccv_lane u_lane_02 (
    ...
    .wake_req(wake_req[6]),
    .sleep_ok(sleep_ok[6]),
    .csr_req(csr_req[294 +: 49]),
    .csr_rsp(csr_rsp[198 +: 33]),
    .csr_credit(csr_credit[6]),
...
`endif
  ...
  ccv_lane u_lane_03 (
    ...
    .wake_req(wake_req[7]),
    .sleep_ok(sleep_ok[7]),
    .csr_req(csr_req[343 +: 49]),
    .csr_rsp(csr_rsp[231 +: 33]),
    .csr_credit(csr_credit[7]),
...
`endif
  ...
  ccv_lane u_lane_04 (
    ...
    .wake_req(wake_req[8]),
    .sleep_ok(sleep_ok[8]),
    .csr_req(csr_req[392 +: 49]),
    .csr_rsp(csr_rsp[264 +: 33]),
    .csr_credit(csr_credit[8]),
...
`endif
  ...
  ccv_lane u_lane_05 (
    ...
    .wake_req(wake_req[9]),
    .sleep_ok(sleep_ok[9]),
    .csr_req(csr_req[441 +: 49]),
    .csr_rsp(csr_rsp[297 +: 33]),
    .csr_credit(csr_credit[9]),
...
`endif
  ...
  ccv_lane u_lane_06 (
    ...
    .wake_req(wake_req[10]),
    .sleep_ok(sleep_ok[10]),
    .csr_req(csr_req[490 +: 49]),
    .csr_rsp(csr_rsp[330 +: 33]),
    .csr_credit(csr_credit[10]),
...
`endif
  ...
  ccv_lane u_lane_07 (
    ...
    .wake_req(wake_req[11]),
    .sleep_ok(sleep_ok[11]),
    .csr_req(csr_req[539 +: 49]),
    .csr_rsp(csr_rsp[363 +: 33]),
    .csr_credit(csr_credit[11]),
...
`endif
  ...
  ccv_lane u_lane_08 (
    ...
    .wake_req(wake_req[12]),
    .sleep_ok(sleep_ok[12]),
    .csr_req(csr_req[588 +: 49]),
    .csr_rsp(csr_rsp[396 +: 33]),
    .csr_credit(csr_credit[12]),
...
`endif
  ...
  ccv_lane u_lane_09 (
    ...
    .wake_req(wake_req[13]),
    .sleep_ok(sleep_ok[13]),
    .csr_req(csr_req[637 +: 49]),
    .csr_rsp(csr_rsp[429 +: 33]),
    .csr_credit(csr_credit[13]),
...
`endif
  ...
  ccv_lane u_lane_10 (
    ...
    .wake_req(wake_req[14]),
    .sleep_ok(sleep_ok[14]),
    .csr_req(csr_req[686 +: 49]),
    .csr_rsp(csr_rsp[462 +: 33]),
    .csr_credit(csr_credit[14]),
...
`endif
  ...
  ccv_lane u_lane_11 (
    ...
    .wake_req(wake_req[15]),
    .sleep_ok(sleep_ok[15]),
    .csr_req(csr_req[735 +: 49]),
    .csr_rsp(csr_rsp[495 +: 33]),
    .csr_credit(csr_credit[15]),
...
`endif
  ...
  ccv_lane u_lane_12 (
    ...
    .wake_req(wake_req[16]),
    .sleep_ok(sleep_ok[16]),
    .csr_req(csr_req[784 +: 49]),
    .csr_rsp(csr_rsp[528 +: 33]),
    .csr_credit(csr_credit[16]),
...
`endif
  ...
  ccv_lane u_lane_13 (
    ...
    .wake_req(wake_req[17]),
    .sleep_ok(sleep_ok[17]),
    .csr_req(csr_req[833 +: 49]),
    .csr_rsp(csr_rsp[561 +: 33]),
    .csr_credit(csr_credit[17]),
...
`endif
  ...
  ccv_lane u_lane_14 (
    ...
    .wake_req(wake_req[18]),
    .sleep_ok(sleep_ok[18]),
    .csr_req(csr_req[882 +: 49]),
    .csr_rsp(csr_rsp[594 +: 33]),
    .csr_credit(csr_credit[18]),
...
`endif
  ...
  ccv_lane u_lane_15 (
    ...
    .wake_req(wake_req[19]),
    .sleep_ok(sleep_ok[19]),
    .csr_req(csr_req[931 +: 49]),
    .csr_rsp(csr_rsp[627 +: 33]),
    .csr_credit(csr_credit[19]),
...
`endif
  ...
  ccv_lane u_lane_16 (
    ...
    .wake_req(wake_req[20]),
    .sleep_ok(sleep_ok[20]),
    .csr_req(csr_req[980 +: 49]),
    .csr_rsp(csr_rsp[660 +: 33]),
    .csr_credit(csr_credit[20]),
...
`endif
  ...
  ccv_lane u_lane_17 (
    ...
    .wake_req(wake_req[21]),
    .sleep_ok(sleep_ok[21]),
    .csr_req(csr_req[1029 +: 49]),
    .csr_rsp(csr_rsp[693 +: 33]),
    .csr_credit(csr_credit[21]),
...
`endif
  ...
  ccv_lane u_lane_18 (
    ...
    .wake_req(wake_req[22]),
    .sleep_ok(sleep_ok[22]),
    .csr_req(csr_req[1078 +: 49]),
    .csr_rsp(csr_rsp[726 +: 33]),
    .csr_credit(csr_credit[22]),
...
`endif
  ...
  ccv_lane u_lane_19 (
    ...
    .wake_req(wake_req[23]),
    .sleep_ok(sleep_ok[23]),
    .csr_req(csr_req[1127 +: 49]),
    .csr_rsp(csr_rsp[759 +: 33]),
    .csr_credit(csr_credit[23]),
...
`endif
  ...
  ccv_lane u_lane_20 (
    ...
    .wake_req(wake_req[24]),
    .sleep_ok(sleep_ok[24]),
    .csr_req(csr_req[1176 +: 49]),
    .csr_rsp(csr_rsp[792 +: 33]),
    .csr_credit(csr_credit[24]),
...
`endif
  ...
  ccv_lane u_lane_21 (
    ...
    .wake_req(wake_req[25]),
    .sleep_ok(sleep_ok[25]),
    .csr_req(csr_req[1225 +: 49]),
    .csr_rsp(csr_rsp[825 +: 33]),
    .csr_credit(csr_credit[25]),
...
`endif
  ...
  ccv_lane u_lane_22 (
    ...
    .wake_req(wake_req[26]),
    .sleep_ok(sleep_ok[26]),
    .csr_req(csr_req[1274 +: 49]),
    .csr_rsp(csr_rsp[858 +: 33]),
    .csr_credit(csr_credit[26]),
...
`endif
  ...
  ccv_lane u_lane_23 (
    ...
    .wake_req(wake_req[27]),
    .sleep_ok(sleep_ok[27]),
    .csr_req(csr_req[1323 +: 49]),
    .csr_rsp(csr_rsp[891 +: 33]),
    .csr_credit(csr_credit[27]),
...
`endif
  ...
  ccv_lane u_lane_24 (
    ...
    .wake_req(wake_req[28]),
    .sleep_ok(sleep_ok[28]),
    .csr_req(csr_req[1372 +: 49]),
    .csr_rsp(csr_rsp[924 +: 33]),
    .csr_credit(csr_credit[28]),
...
`endif
  ...
  ccv_lane u_lane_25 (
    ...
    .wake_req(wake_req[29]),
    .sleep_ok(sleep_ok[29]),
    .csr_req(csr_req[1421 +: 49]),
    .csr_rsp(csr_rsp[957 +: 33]),
    .csr_credit(csr_credit[29]),
...
`endif
  ...
  ccv_lane u_lane_26 (
    ...
    .wake_req(wake_req[30]),
    .sleep_ok(sleep_ok[30]),
    .csr_req(csr_req[1470 +: 49]),
    .csr_rsp(csr_rsp[990 +: 33]),
    .csr_credit(csr_credit[30]),
...
`endif
  ...
  ccv_lane u_lane_27 (
    ...
    .wake_req(wake_req[31]),
    .sleep_ok(sleep_ok[31]),
    .csr_req(csr_req[1519 +: 49]),
    .csr_rsp(csr_rsp[1023 +: 33]),
    .csr_credit(csr_credit[31]),
...
`endif
  ...
  ccv_lane u_lane_28 (
    ...
    .wake_req(wake_req[32]),
    .sleep_ok(sleep_ok[32]),
    .csr_req(csr_req[1568 +: 49]),
    .csr_rsp(csr_rsp[1056 +: 33]),
    .csr_credit(csr_credit[32]),
...
`endif
  ...
  ccv_lane u_lane_29 (
    ...
    .wake_req(wake_req[33]),
    .sleep_ok(sleep_ok[33]),
    .csr_req(csr_req[1617 +: 49]),
    .csr_rsp(csr_rsp[1089 +: 33]),
    .csr_credit(csr_credit[33]),
...
`endif
  ...
  ccv_lane u_lane_30 (
    ...
    .wake_req(wake_req[34]),
    .sleep_ok(sleep_ok[34]),
    .csr_req(csr_req[1666 +: 49]),
    .csr_rsp(csr_rsp[1122 +: 33]),
    .csr_credit(csr_credit[34]),
...
`endif
  ...
  ccv_lane u_lane_31 (
    ...
    .wake_req(wake_req[35]),
    .sleep_ok(sleep_ok[35]),
    .csr_req(csr_req[1715 +: 49]),
    .csr_rsp(csr_rsp[1155 +: 33]),
    .csr_credit(csr_credit[35]),
...
`endif
  ...
  ccv_miu u_miu (
    ...
    .wake_req(wake_req[36]),
    .sleep_ok(sleep_ok[36]),
    .csr_req(csr_req[1764 +: 49]),
    .csr_rsp(csr_rsp[1188 +: 33]),
    .csr_credit(csr_credit[36]),
    .rcu_miu_addr_valid(rcu_miu_addr_valid),
    .rcu_miu_addr_payload(rcu_miu_addr_payload),
    .rcu_miu_addr_credit(rcu_miu_addr_credit),
    .rcu_miu_addr_stall(rcu_miu_addr_stall),
...
`endif
  ...
  ccv_spm u_spm (
    ...
    .wake_req(wake_req[37]),
    .sleep_ok(sleep_ok[37]),
    .csr_req(csr_req[1813 +: 49]),
    .csr_rsp(csr_rsp[1221 +: 33]),
    .csr_credit(csr_credit[37]),
    .miu_spm_req_valid(miu_spm_req_valid),
    .miu_spm_req_payload(miu_spm_req_payload),
    .miu_spm_req_credit(miu_spm_req_credit),
    .miu_spm_req_stall(miu_spm_req_stall),
...
`endif
  ...
  ccv_dcu u_dcu (
    ...
    .wake_req(wake_req[38]),
    .sleep_ok(sleep_ok[38]),
    .csr_req(csr_req[1862 +: 49]),
    .csr_rsp(csr_rsp[1254 +: 33]),
    .csr_credit(csr_credit[38]),
    .miu_dcu_req_valid(miu_dcu_req_valid),
    .miu_dcu_req_payload(miu_dcu_req_payload),
    .miu_dcu_req_credit(miu_dcu_req_credit),
    .miu_dcu_req_stall(miu_dcu_req_stall),
...
`endif
  ...
  ccv_mlc u_mlc (
    ...
    .wake_req(wake_req[39]),
    .sleep_ok(sleep_ok[39]),
    .csr_req(csr_req[1911 +: 49]),
    .csr_rsp(csr_rsp[1287 +: 33]),
    .csr_credit(csr_credit[39]),
    .dcu_mlc_req_valid(dcu_mlc_req_valid),
    .dcu_mlc_req_payload(dcu_mlc_req_payload),
    .dcu_mlc_req_credit(dcu_mlc_req_credit),
    .dcu_mlc_req_stall(dcu_mlc_req_stall),
...
`endif
  ...
  ccv_rau u_rau (
    ...
    .kill_valid(kill_valid),
    .kill_warp_mask(kill_warp_mask),
    .kill_ack(kill_ack[40]),
    .wake_req(wake_req[40]),
    .sleep_ok(sleep_ok[40]),
    .csr_req(csr_req[1960 +: 49]),
    .csr_rsp(csr_rsp[1320 +: 33]),
    .csr_credit(csr_credit[40]),
    .rau_fet_launch_valid(rau_fet_launch_valid),
    .rau_fet_launch_payload(rau_fet_launch_payload),
    .rau_fet_launch_credit(rau_fet_launch_credit),
    .rau_fet_launch_stall(rau_fet_launch_stall),
...
`endif
  ...
  ccv_syu u_syu (
    ...
    .wake_req(wake_req[41]),
    .sleep_ok(sleep_ok[41]),
    .csr_req(csr_req[2009 +: 49]),
    .csr_rsp(csr_rsp[1353 +: 33]),
    .csr_credit(csr_credit[41]),
    .ooe_syu_bar_valid(ooe_syu_bar_valid),
    .ooe_syu_bar_payload(ooe_syu_bar_payload),
    .ooe_syu_bar_credit(ooe_syu_bar_credit),
    .ooe_syu_bar_stall(ooe_syu_bar_stall),
...
`endif
  ...
  ccv_pca u_pca (
    ...
    .wake_req(wake_req[42]),
    .sleep_ok(sleep_ok[42]),
    .csr_req(csr_req[2058 +: 49]),
    .csr_rsp(csr_rsp[1386 +: 33]),
    .csr_credit(csr_credit[42]),
    .rcu_pca_mig_valid(rcu_pca_mig_valid),
    .rcu_pca_mig_payload(rcu_pca_mig_payload),
    .rcu_pca_mig_credit(rcu_pca_mig_credit),
    .rcu_pca_mig_stall(rcu_pca_mig_stall),
...
`endif
  ...
  ccv_cru u_cru (
    ...
    .wake_req(wake_req[43]),
    .sleep_ok(sleep_ok[43]),
    .csr_req(csr_req[2107 +: 49]),
    .csr_rsp(csr_rsp[1419 +: 33]),
    .csr_credit(csr_credit[43]),
    .ooe_cru_fault_valid(ooe_cru_fault_valid),
    .ooe_cru_fault_payload(ooe_cru_fault_payload),
    .ooe_cru_fault_credit(ooe_cru_fault_credit),
    .ooe_cru_fault_stall(ooe_cru_fault_stall),
...
`endif
  ...
  ccv_exb u_exb (
    ...
    .wake_req(wake_req[44]),
    .sleep_ok(sleep_ok[44]),
    .csr_req(csr_req[2156 +: 49]),
    .csr_rsp(csr_rsp[1452 +: 33]),
    .csr_credit(csr_credit[44]),
    .mlc_exb_req_valid(mlc_exb_req_valid),
    .mlc_exb_req_payload(mlc_exb_req_payload),
    .mlc_exb_req_credit(mlc_exb_req_credit),
    .mlc_exb_req_stall(mlc_exb_req_stall),
...
`ifdef CCV_CHECK
  ...
  ccv_skel_checkers u_checkers (
    .clk(core_clk), .rst_n(rst_n), .force_atomic(1'b0),
